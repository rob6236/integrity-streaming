  ...
  return (
    <>
      <style jsx>{`
        ...
        /* Mobile: stack into a single column and tighten padding */
      ...
      <div className="meme-root">
        ...
        <p style={{ opacity: 0.85, marginBottom: 24 }}>
          Use AI or your own graphics to create a meme for your social feed.
          When you&apos;re finished, send it back to your Posts (Social)
          composer.
        </p>
          ...
          >
            ...
            >
              ...
              {imageUrl ? (
                ...
                >
                  Big blank white canvas. Upload an image or use AI to generate
                  an idea, then add your text.
                </span>
              )}
